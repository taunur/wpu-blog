  ...
  <div class="col-md-6">
    ...
    @endif
      <div class="input-group mb-3">
        <input type="text" autocomplete="off" class="form-control" placeholder="Search.." name="search" value="{{ request('search') }}">
...
<div class="card mb-3">
  @if ($posts[0]->image)
  <div style="max-height:400px; overflow:hidden" class="justify-cotent-center">
  ...
  <div class="row">
    @foreach ($posts->skip(1) as $post )
      <div class="col-md-4 mb-3">
        <div class="card">
          <div 
          class="position-absolute bg-dark px-3 py-2 text-white" 
